...
var path1 =localStorage.getItem("card_img_z");
var path2 = localStorage.getItem("card_img_f");
var path3 = localStorage.getItem("xs_img");
var path4 = localStorage.getItem("js_img");
var path5 = localStorage.getItem("insurance_img");
var path6 = localStorage.getItem("car_pe_img");
var path7 = localStorage.getItem("urgent_img");
var path8 = localStorage.getItem("account_book_img");
var arrPic = new Array(path1,path2,path3,path4,path5,path6,path7,path8); //定义一个数组
...
$("img[modal='zoomImg']").each(function() {
	$(this).on("click", function() {
		...
		function showImg() {
			...
			var path7 = localStorage.getItem("urgent_img");
			var path8 = localStorage.getItem("account_book_img");
			var arrPic = new Array(path1,path2,path3,path4,path5,path6,path7,path8);
