...
/*** 极光推送  通知推送*****/
class JPushZDY{
    private $app_key = '408fa4580544c0082b56faf7';        //待发送的应用程序(appKey)，只能填一个。
    private $master_secret ='00b2a2ec109f0182ee18fa9a';    //主密码
    ...
    */
    ...
    public function push($receiver='all',$content='',$m_type='',$m_txt='',$m_time='86400',$apns_production=true){  //0开发环境，1生产环境。
        $base64=base64_encode("$this->app_key:$this->master_secret");
        $header=array("Authorization:Basic $base64","Content-Type:application/json");
        $data = array();
        $data['platform'] = 'all';          //目标用户终端手机的平台类型android,ios,winphone,all
...
//        );
        ...
        $data['options'] = array(
            ...
            "apns_production"=>$apns_production, //布尔类型   指定 APNS 通知发送环境：0开发环境，1生产环境。或者传递false和true
            //$apns_production
        );
